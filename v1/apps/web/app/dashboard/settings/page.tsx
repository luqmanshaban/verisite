...
function Row({ label, value, highlight }: { label: string; value: string; highlight?: boolean }) {
  return (
    <div style={rowStyles.row}>
      ...
      <span style={{ ...rowStyles.value, color: highlight ? "var(--safe)" : "var(--ink)", fontWeight: highlight ? 600 : 400 }}>
        {value}
      </span>
    </div>
  );
...
const rowStyles: Record<string, React.CSSProperties> = {
  ...
  label: { fontSize: "13px", color: "var(--muted)", fontFamily: "'Inter', sans-serif" },
  value: { fontSize: "13px", fontFamily: "'Inter', sans-serif" },
};
...
const styles: Record<string, React.CSSProperties> = {
  ...
  sectionLabel: { fontFamily: "'JetBrains Mono', monospace", fontSize: "11px", color: "var(--muted)", letterSpacing: "0.08em", marginBottom: "12px" },
  card: { border: "1px solid var(--border)", background: "white", overflow: "hidden" },
  upgradeCard: { border: "1px solid var(--border)", background: "white", padding: "20px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "16px", flexWrap: "wrap" },
  upgradeTitle: { fontSize: "14px", fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600, marginBottom: "4px" },
  upgradeDesc: { fontSize: "12px", color: "var(--muted)", fontFamily: "'Inter', sans-serif" },
  upgradeBtn: { padding: "10px 20px", background: "var(--ink)", color: "var(--paper)", border: "none", fontSize: "13px", fontWeight: 600, fontFamily: "'Space Grotesk', sans-serif", cursor: "pointer", flexShrink: 0 },
};